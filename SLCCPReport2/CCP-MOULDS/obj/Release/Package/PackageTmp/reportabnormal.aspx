...
<%@ Page Async="True" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="reportabnormal.aspx.cs" Inherits="CCP_MOULDS.reportabnormal" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div>
         <br />
    <%--<asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center" Height="400px" ScrollBars="Auto"> 
       <%-- AllowTextWrap="true"
